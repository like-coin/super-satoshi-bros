...
Satoshi.testMap = {
  ...
  "areas": [
    ...
    "creation": [
      ...
      { "thing": "CustomText", "x": 24.5, "y": 68, "texts": [
        { "text": "SATOSHI" }
      ]},
      { "thing": "CustomText", "x": 23.5, "y": 62, "texts": [
        { "text": "NAKAMOTO" }
      ]},
...
// Change Default Map
FSM.prototype.settings.maps.mapDefault = "1-4";
FSM.prototype.settings.maps.mapDefault = "Random";
FSM.prototype.settings.maps.mapDefault = "satoshi-test";
// FSM.prototype.settings.maps.mapDefault = "block-1";

console.log("FSM.prototype.settings.maps", FSM.prototype.settings.maps);
console.log("FSM.prototype.settings.maps.library", FSM.prototype.settings.maps.library);
